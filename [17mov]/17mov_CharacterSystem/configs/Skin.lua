...
Skin.DisableHealthRegen = false                                                  -- Disable health regeneration     
...
Skin.RememberLastOutfit = true                                                  -- Set to true to save your last weared outfit
Skin.PlayAnimWhenOpened = true                                                   -- Play animation when skin menu is opened
