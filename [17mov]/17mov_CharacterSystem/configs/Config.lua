...
Config.PrimaryIdentifier = GetResourceState("qbx_core") == "missing" and "license" or "license2"
...
Config.TimePerPhoto = 100                                     -- Tells how much time (in ms) we should wait after setting specified clothes on ped and before taking a photo. Lower value = process is faster. Higher value = process is slower. It's not recommended to go below 100ms.
