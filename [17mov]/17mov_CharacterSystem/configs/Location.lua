...
Location.EnableSpawningInHouse = true                                       -- Let player spawn into their houses if they have any
Location.EnableSpawningInApartment = true                                   -- Let player spawn into their apartments if they have any
Location.SelectApartmentAtFirstSpawn = true                                 -- Let players choose a spawn apartment from available apartments
