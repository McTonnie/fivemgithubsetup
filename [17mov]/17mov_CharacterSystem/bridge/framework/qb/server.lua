...
while Core == nil do
    ...
    if GetGameTimer() - startTime >= 10000 and Core == nil then
        Functions.Print("Cannot fetch your framework. Please make sure you're using ESX & QBCore, and you're starting Character System after your framework")
    end
end
...
RegisterServerEvent("qb-clothing:server:removeOutfit", function(outfitName)
