...
RegisterNetEvent('qb-clothes:client:CreateFirstCharacter', function()
    if Selector.JustCreatedCharacter then
        Selector.JustCreatedCharacter = false
        return print("^5[17mov_CharacterSystem] ^3WARN: Triggered qb-clothes:client:CreateFirstCharacter event, but character has just been created.^0")
    end
    ...
    Core.Functions.GetPlayerData(function(pData)
        ...
        }, "creator", true, pData.charinfo.gender == 0)
    end)
end)
