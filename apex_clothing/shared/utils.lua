--[[
    Apex Clothing Studio — Shared Utilities
    ────────────────────────────────────────────────────────────
...
function Utils.Log(...)
    ...
    print('^5[apex_clothing]^7 ' .. joinArgs(...))
end

--- Non-fatal warning. Always printed.
function Utils.Warn(...)
    print('^3[apex_clothing]^7 ' .. joinArgs(...))
end

--- Error. Always printed.
function Utils.Err(...)
    print('^1[apex_clothing]^7 ' .. joinArgs(...))
end
...
function Utils.ActiveLocale()
    ...
    local own = GetResourceKvpString('apex_clothing_lang')
